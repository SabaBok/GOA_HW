...
const cardAll = mainMid.querySelectorAll("div")[0]
const cardGoing = mainMid.querySelectorAll("div")[1]
const cardFinished = mainMid.querySelectorAll("div")[0]
...
//         // const allCards = Array.from(mainBot.querySelectorAll(".card"));
//         // let goingCards = onGoing.querySelectorAll(".card")
//         // let card = e.target.closest('.card')

//         // let mainIndex = allCards.indexOf(card)
//         // let goingIndex = goingIndex.indexOf(goingCards)
//         // goingCards[goingIndex].remove()
//         // card.remove()
//         // tasks.splice(mainIndex)
//         // localStorage.setItem("events",JSON.stringify(tasks))

//         const allFinished = document.querySelector(".finished").querySelectorAll(".card")
//         const allGoing = document.querySelector(".onGoing").querySelectorAll(".card")
//         const allCards = document.querySelector(".main-bot").querySelectorAll(".card")
