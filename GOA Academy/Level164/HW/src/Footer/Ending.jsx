...
export default function Ending() {
	return (
		<section className='bg-[#F0F0F0] h-full w-full flex flex-col items-center'>
			<Subscribe></Subscribe>

			<div className='w-[90%] flex items-center max-md:flex-col max-md:gap-8'>
				...
				<div className='w-full grid grid-cols-[repeat(auto-fit,minmax(120px,1fr))] max-md:justify-items-start justify-items-center items-start gap-5'>
			...
			<div className='w-[90%] flex max-md:flex-col items-center justify-between border-t border-[#0000001A] pt-[10px]'>
