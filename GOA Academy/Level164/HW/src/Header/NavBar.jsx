...
export default function NavBar() {
	return (
		<section className='flex max-w-[1200px] w-[90%] gap-20 justify-center items-center py-[20px]'>	
			<p className='text-[34px] font-oswald font-[900]'>SHOP.CO</p>

			<nav className='min-w-[320px]'>
			...
			<form className='min-w-[300px] max-w-[450px] w-[40%]'>
