...
//     let parent = document.querySelector(".listing");
//     let originalListing = document.querySelector(".cool-cont");
//     let clone = originalListing.cloneNode(true);
//     let chang = clone.querySelectorAll(".chang")
//     let info = {
//         price: clone.querySelector(".idk span"),
//         displayImg: clone.querySelector(".card-img"),
//         square: clone.querySelector(".square"),
//         bed: clone.querySelector(".beds"),
//         quickText: clone.querySelector(".card-price p"),
//         location: clone.querySelector(".card-loc p")
//     }
