...
export default function Header() {
	...
	return (
		<header className='max-md:px-5 w-full fixed top-0 shadow-[0_2px_8px_rgba(0,0,0,0.12)] z-10 bg-white text-black flex justify-between items-center px-5 xl:px-30 py-5 flex-wrap gap-6 border-b border-[#a1a1a131]'>
			<div className='flex items-center gap-4'>
				<img src="/images/food.png" alt="" className='w-10' />
				<h1 className='font-bold text-[25px] font-lexend-zetta '>GOA-TONA</h1>
				<p className='max-lg:hidden'>Money: <span className='text-green-500'>${user.money}</span>  <span ref={span} className='duration-300' style={{ opacity: 0 }}></span></p>
			</div>
