...
export default function CardTable() {
	const { filters, filteredData } = useContext(DataInfo)
	...
	return (
		<section className='w-full flex flex-col gap-x-4 gap-y-7 items-center'>
			<div className='flex justify-between w-full'>
				<h3 className='text-[25px] font-[700]'>{filters.dressStyle?filters.dressStyle:filters.clothesType}</h3>
				<p className='text-[#00000099]'>Showing {filteredData.length} Products</p>
			</div>

			<div className='w-full grid grid-cols-3 gap-x-5 gap-y-7 max-kkk:grid-cols-[repeat(auto-fit,minmax(300px,1fr))] items-center justify-items-center'>
				{
