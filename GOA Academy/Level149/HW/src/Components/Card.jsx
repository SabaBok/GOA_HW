		...
		>
			<div className="movie-poster relative rounded-lg group w-full ">
				...
				<div className="movie-overlay flex justify-end gap-2 items-start w-full h-full absolute top-[5px] right-[8px]">
					...
					>
						{isLiked?<i className="fa-solid fa-heart text-base relative z-4 top-[1px] text-red-500 cursor-pointer"></i>: <i className="fa-solid fa-heart text-base relative z-4 top-[1px] cursor-pointer"></i>}
					</button>
				</div>
			</div>
